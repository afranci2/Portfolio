  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className=" bg-white px-10 dark:bg-black md:px-20 lg:px-40">
        <section className="min-h-screen">
          ...
          <Image className="" src={web7} width={45} height={45} alt="wef" />
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a
                  className="bg-gradient-to-r from-red-700 text- to-red-700 text-white px-4 py-2 border-none rounded-md ml-8 dark:bg-gradient-to-r dark:from-cyan-500 text- dark:to-teal-500"
                  href="#"
                >
                  Resume
                </a>
        ...
        <section>
          <div>
            <h3 className="font-serif font-semibold text-4xl py-1 dark:text-white ">Services I offer</h3>
